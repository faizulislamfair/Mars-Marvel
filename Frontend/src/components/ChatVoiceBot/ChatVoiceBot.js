...
const ChatVoiceBot = () => {
    return (
        <div className='xs:-ml-7 md:block w-full'>
            <div className='max-w-[1240px] mx-auto px-2 text-[#E5DBCC]'>
                <div className='flex flex-col px-12 m-5'>
                    ...
                    <div className='flex flex-row justify-between p-5'>
                        ...
                        <h3 className='xs:-ml-7 md:ml-0 text-3xl translate-x-12'>Chat & Voice Bot</h3>
                    ...
                    <div className='flex flex-row'>
                        <p className='xs:hidden md:block text-2xl mt-20 p-10'>You can start by saying "hello" <br></br> or "hey yeah"!</p>

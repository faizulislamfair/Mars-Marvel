        ...
        <div className='w-full'>
            <div className='max-w-[1240px] mx-auto px-2'>
                ...
                <div className='m-10'>
                    ...
                    <div className='container justify-items-center pt-7'>
                        <div className='grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 justify-items-center mt-12 gap-10 text-2xl'>
